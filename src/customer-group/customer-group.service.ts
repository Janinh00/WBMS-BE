...
export class CustomerGroupService {
  ...
  async create(dto: CreateCustomerGroupDto, userId: string): Promise<CustomerGroupEntity> {
    const params = {
      data: {
        ...dto,
        userCreated: userId,
  ...
  async updateById(id: string, dto: UpdateCustomerGroupDto, userId: string): Promise<CustomerGroupEntity> {
    const params = {
      where: { id },
