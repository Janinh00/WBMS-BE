...
export class CustomerService {
  ...
  async create(dto: CreateCustomerDto, userId: string): Promise<CustomerEntity> {
    const params = {
      data: {
        ...dto,
        userCreated: userId,
  ...
  async updateById(id: string, dto: UpdateCustomerDto, userId: string): Promise<CustomerEntity> {
    const params = {
      where: { id },
