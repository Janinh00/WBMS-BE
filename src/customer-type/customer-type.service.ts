...
export class CustomerTypeService {
  ...
  async create(dto: CreateCustomerTypeDto, userId: string): Promise<CustomerTypeEntity> {
    const params = {
      data: {
        ...dto,
        userCreated: userId,
  ...
  async updateById(id: string, dto: UpdateCustomerTypeDto, userId: string): Promise<CustomerTypeEntity> {
    const params = {
      where: { id },
